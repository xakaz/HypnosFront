...
export default function MonCompte() {
  ...
  const replaceText = (text) => {
    return text.replace("&ocirc;", 'ô').replaceAll("&eacute;", "é").replaceAll("&agrave;", "à").replaceAll("&rsquo;", "'").replaceAll("&#039;", "'").replaceAll("&iuml;", "ï")
  }
                  ...
                  <div key={uuid_v4()} className="row">
                    ...
                    <div className="col-12 col-xl-4 ">
                      <div className="border rounded mb-3 p-5" >
                        ...
                        <hr />
                        <p>{replaceText(user.user_prenom)}</p>
                        <p>{replaceText(user.user_nom)}</p>
                        <p>{replaceText(user.user_mail)}</p>
                      </div>
                    </div>
